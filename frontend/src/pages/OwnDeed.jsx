  ...
  return (
    <div className="pure-root">
      ...
      <div className="tabs-container">
        <Link to="/SE/Pure" className="tab-button" onClick={saveScroll}>Pure Play 1031</Link>
        <Link to="/SE/OwnDeed" className="tab-button active" onClick={saveScroll}>Own The Deed</Link>
      </div>
